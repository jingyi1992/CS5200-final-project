...
<html>
  ...
  <body>
   <form name="queryStudent2" method="post" action="servlet/queryStudent2">	
...
%>
	...
	<table width="100%" border=1" cellpadding="0" cellspacing="0"
		...
		<tr class="COL_A">
			...
			<td class="TABLE_COL" align="center">
				<a href="Error.html?sno=<%=rs.getString("sno") %>">Delete
				</a>
			</td>
		 </tr>

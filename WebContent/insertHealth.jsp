...
<html>
  ...
  <body>
   <center>
    <h3> Insert physical examination</h3>
   ...
   <form name="insertHealth" method="post" action="servlet/insertHealth"  >  
 	 <table width="405" border="o.2" cellpadding="0" cellspacing="0" height="333">
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
						<input type="text" name="history" value="none" />Filling in the blank if having medical history<br>
			</td>
		</tr>
		<tr class="COL_A">
    		<td width="10%" class="TABLE_HEAD" align="center">
			...
			<td width="14%" class="TABLE_COL" align="left">
						<input type="text" name="h_text" value="None" />Filling in the blank if necessary<br>  
			</td>
		</tr>
		<tr class="COL_A">

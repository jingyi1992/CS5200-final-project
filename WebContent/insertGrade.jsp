    ...
    <h3> Insert grade</h3>
 	  <form name="insertGrade" method="post" action="servlet/insertGrade"  >
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
					<SELECT NAME="cno">
		   			 <OPTION VALUE="1">	 Written test					
		   			 <OPTION VALUE="2">	 Parking test
		    		<OPTION VALUE="3">	 Road test   		
	    		 </SELECT>		<br>
			</td>
		</tr>
		<tr class="COL_A">
    		<td width="10%" class="TABLE_HEAD" align="center">
							Times of taking tests:   
			</td>
			<td width="14%" class="TABLE_COL" align="left" >
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
			   <input name="last_time" type="text" id="lastTime" title="点击选择" onClick="javascript:ShowCalendar(this.id)" size="20">
              <input type="button" name="Submit" value="Select" onClick="javascript:ShowCalendar('lastTime')">  <br>
			</td>
		</tr>
		<tr class="COL_A">
    		<td width="10%" class="TABLE_HEAD" align="center">

...
<html>
  ...
  <body>
  <center>
   <h3>Insert coach comment</h3>
   <form name="insertComment" method="post" action="servlet/insertComment"  >
    <table width="465" border="o.2" cellpadding="0" cellspacing="0" height="333">
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
							<input type="text" name="dno" value=""/>		<br>
			</td>
		</tr>
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
			   <input name="comment_time" type="text" id="comment_time" title="点击选择" onClick="javascript:ShowCalendar(this.id)" size="20">
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
							<input type="text" property="comment_name" value="" /><br>
			</td>
		</tr>
		<tr class="COL_A">
    		<td width="10%" class="TABLE_HEAD" align="center">
			...
			<td width="14%" class="TABLE_COL" align="left">
							<input type="text" name="c_text" value="None" /><br>
			</td>
		</tr>
		<tr class="COL_A">

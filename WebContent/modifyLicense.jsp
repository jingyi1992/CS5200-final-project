...
<html>
  ...
  <body>
    ...
    <center>
		<h3>	Modify license information			
			<form name="modifyLicense" method="post" action="servlet/modifyLicense">
			<table width="465" border="o.2" cellpadding="0" cellspacing="0" height="333">
				
				<%
				String sno=request.getParameter("sno");
				String sql1="SELECT * FROM licenseInfo WHERE sno="+sno;
				DB db1 = new DB();
				db1.connectMySQL();
			    ...
			    %>
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							<input type="text" name="lno" value="<%=rs1.getString("lno")%>">
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							 <input name="receive_time" type="text" value="<%=rs1.getString("receive_time")%>" id="receive_time" title="点击选择" onClick="javascript:ShowCalendar(this.id)" >
              				<input type="button" name="Submit" value="Select" onClick="javascript:ShowCalendar('receive_time')">  <br>
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							<input type="text" name="receive_name" value="<%=rs1.getString("receive_name")%>">
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							<input type="text"  name="l_text" value="<%=rs1.getString("l_text") %>">

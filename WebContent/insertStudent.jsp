  ...
  <body>
  	...
  	<form name="insertStudent" method="post" action="servlet/insertStudent"  >
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
			  <input name="enrollTime" type="text" id="enrollTime" title="Select" onClick="javascript:ShowCalendar(this.id)" size="20">
              <input type="button" name="Submit" value="Select" onClick="javascript:ShowCalendar('enrollTime')">  <br>
			</td>
		</tr>
		<tr class="COL_A">
    		<td width="5%" class="TABLE_HEAD" align="center">
			...
			<td width="14%" class="TABLE_COL" align="left">
			  <input name="leaveTime" type="text" id="leaveTime" title="Select" onClick="javascript:ShowCalendar(this.id)" size="20">
              <input type="button" name="Submit" value="Select" onClick="javascript:ShowCalendar('leaveTime')">  <br>
			</td>
		</tr>
		<tr class="COL_A">
    		<td width="5%" class="TABLE_HEAD" align="center">
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
							 <input type="text" name="stext" value="None" />
							 Filling in the blank if necessary
			</td>
		</tr>
		<tr class="COL_A">

...
<html>
  ...
  <body>
    ...
    <center>
		<h3>	Modify Comment information			
			<form name="modifyComment" method="post" action="servlet/modifyComment">
			<table width="465" border="o.2" cellpadding="0" cellspacing="0" height="333">
				
				<%
				String dno=request.getParameter("dno");
				String sql1="SELECT * FROM driverComment WHERE dno="+dno;
				DB db1 = new DB();
				db1.connectMySQL();
			    ...
			    %>
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							<input type="text" name="dno" value="<%=rs1.getString("dno") %>" readonly="true">  
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							 <input name="comment_time" type="text" value="<%=rs1.getString("comment_time")%>" id="comment_time" title="点击选择" onClick="javascript:ShowCalendar(this.id)" >
              				<input type="button" name="Submit" value="Select" onClick="javascript:ShowCalendar('comment_time')">  <br>
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							<input type="text" name="comment_name" value="<%=rs1.getString("comment_name")%>">
					...
					<tr class="COL_A">
						...
						<td class="TABLE_COL" align="left">
							<input type="text"  name="c_text" value="<%=rs1.getString("c_text") %>">

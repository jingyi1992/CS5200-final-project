...
<html>
  ...
  <body>
   ...
   <form name="queryComment" method="post" action="servlet/queryComment">	
...
%>
	<table width="100%" border="o.5" cellpadding="0" cellspacing="0"
		...
		<tr class="COL_A">
			...
			<td class="TABLE_COL" align="center">
				<a href="modifyComment.jsp?dno=<%=rs.getString("dno") %>">Modify
				</a>
			</td>		
			<td class="TABLE_COL" align="center">
				<a href="servlet/deleteComment?id=<%=rs.getString("id") %>">Delete
				</a>
			</td>
		 </tr>
		<%}

				...
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							...
							title="添加用户" href="Error.html" target="WORK"> Insert user</a></td>
					</tr>
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit05.gif" width="8" align="absMiddle"> <a
							title="修改密码" href="modifyPasswd.jsp" target="WORK"> modify
								password</a></td>
					</tr>
			...
			<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="添加学员" href="Error.html" target="WORK"> Insert student</a>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="查询" href="queryStudent2.jsp" target="WORK"> Search</a></td>
					</tr>
			...
			<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="添加教练" href="Error.html" target="WORK"> Insert coach</a></td>
					</tr>
					<tr>
						<td background height="3"></td>
					</tr>
					...
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="查询/修改/删除" href="queryDriver2.jsp" target="WORK">
								Search</a></td>
					</tr>
			...
			<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="添加体检信息" href="Error.html" target="WORK"> Insert
					...
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="查询" href="queryHealth2.jsp" target="WORK"> Search</a></td>
					</tr>
			...
			<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="增加成绩信息" href="Error.html" target="WORK"> Insert grade</a>
						</td>
					</tr>
					<tr>
						<td background height="3"></td>
					...
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="查询" href="queryGrade2.jsp" target="WORK"> Search</a></td>
					</tr>
					<tr>
						<td background height="3"></td>
					</tr>
			...
			<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="添加驾驶证领取信息" href="Error.html" target="WORK"> Insert
								license receiving information</a></td>
					</tr>
					<tr>
						<td background height="3"></td>
					</tr>
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="查询" href="queryLicense2.jsp" target="WORK"> Search</a></td>
					</tr>
					<tr>
						<td background height="3"></td>
					</tr>
			...
			<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					...
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="查询/修改/删除" href="queryComment2.jsp" target="WORK">
								Search</a></td>
					</tr>

...
<html>
  ...
  <body>
   ...
   <form name="queryComment3" method="post" action="servlet/queryComment3">	
...
%>
	<table width="100%" border="o.5" cellpadding="0" cellspacing="0"
		...
		<tr class="COL_A">
			...
			<td class="TABLE_COL" align="center">
				<a href="Error2.html?dno=<%=rs.getString("dno") %>">Modify
				</a>
			</td>		
			<td class="TABLE_COL" align="center">
				<a href="Error2.html?id=<%=rs.getString("id") %>">Delete
				</a>
			</td>
		 </tr>
		<%}

...
<html>
  ...
  <body>
  <center>
   <h3>Insert receiving license information</h3>
   <form name="insertLicense" method="post" action="servlet/insertLicense"  >
    <table width="465" border="o.2" cellpadding="0" cellspacing="0" height="333">
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
			   <input name="receive_time" type="text" id="receive_time" title="点击选择" onClick="javascript:ShowCalendar(this.id)" size="20">
		...
		<tr class="COL_A">
			...
			<td width="14%" class="TABLE_COL" align="left">
							<input type="text" property="receive_name" value="" />Name<br>
			</td>
		</tr>
		<tr class="COL_A">
    		<td width="10%" class="TABLE_HEAD" align="center">
			...
			<td width="14%" class="TABLE_COL" align="left">
							<input type="text" name="l_text" value="None" />Reason when necessary<br>
			</td>
		</tr>
		<tr class="COL_A">

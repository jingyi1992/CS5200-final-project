				...
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							...
							title="添加用户" href="Error2.html" target="WORK"> Insert user</a></td>
					</tr>
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img	height="7" 
			...
			<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="添加教练" href="Error2.html" target="WORK"> Insert
								coach comment</a></td>
					</tr>
					<tr>
						<td background height="3"></td>
					...
					<tr>
						<td style="PADDING-LEFT: 40px" height="23"><img height="7"
							src="imagesjs/bit06.gif" width="8" align="absMiddle"> <a
							title="查询/修改/删除" href="queryComment3.jsp" target="WORK">
								Search</a></td>
					</tr>
